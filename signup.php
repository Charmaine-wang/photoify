...
<article class="article-create">
  ...
  <form action="app/users/create.php" method="post" class="form-create">
    ...
    <div class="form-group">
      ...
      <input class="signup-text" type="username" name="username" id="username" required><br>
    ...
    <div class="form-group">
      ...
      <input class="signup-text" type="name" name="name" id="name" required><br>
    ...
    <div class="form-group">
      ...
      <input class="signup-text" type="password" name="password" id="password" required><br>
      <small class="form-text text-muted">Please provide the your password (passphrase).</small>
    </div><!-- /form-group -->

    <div class="form-group">
      <label class="signup-label" for="r_password">REPEAT PASSWORD</label>
      <input class="signup-text" type="password" name="r_password" id="r_password" required><br>
      <small class="form-text text-muted">Please provide the your password (passphrase).</small>
    </div><!-- /form-group -->
